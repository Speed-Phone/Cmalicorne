    ...
    <main className="min-h-screen bg-gray-50 pt-40 pb-20 px-6 font-sans">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100 text-[10px] font-bold uppercase text-purple-800 tracking-tighter leading-relaxed">
            🛡️ Paiement sécurisé via Stripe. Tes données sont protégées.
          </div>
        </div>
      </div>
    </main>
